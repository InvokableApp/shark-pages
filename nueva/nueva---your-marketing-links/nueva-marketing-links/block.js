  ...
  groups: [
    {
      ...
      items: [
        { icon: "leaf", name: "Hormone Lunchbox Guide",
          slug: "n-hormone-lunchbox", scripts: "https://sharksuite.ai/hormone-recipe-scripts",
        ...
        { icon: "chart", name: "Natural GLP Foods Guide",
          slug: "n-glp-food-guide", scripts: "https://sharksuite.ai/glp-foods-guide-scripts",
    ...
    },
    {
      ...
      items: [
        { icon: "quiz", name: "Side Hustle Quiz",
          slug: "n-match-quiz", scripts: "https://sharksuite.ai/side-hustle-scripts",
