(function () {
  ...
  /* The rep's SHARK affiliate link.
     ...
     This refers people to the GLP SHARK MARKETING SYSTEM, not to ORYGN product or
     the ORYGN opportunity. Every other link on this page points a lead at the rep's
     own business; this one points a fellow rep at the system the page itself is part
     of, so the copy has to say so plainly or it reads as a downline referral.
